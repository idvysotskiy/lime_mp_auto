...
class TestCheckOut:
    ...
    @allure.title('Экран "Оформление заказа" / Успешный результат без 3-D Secure')
    ...
    @allure.title('Экран "Оформление заказа" / Недостаточно средств на карте без 3-D Secure')
